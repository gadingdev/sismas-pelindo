...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 mb-0 fw-bold">
            <i class="fas fa-pen me-2" style="color: #003366;"></i> Edit Kategori
        </h1>
        <p class="text-muted small">Perbarui data kategori</p>
    </div>
        ...
        <form action="{{ route('kategori.update', $kategori->id) }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="kode_kka" value="{{ old('kode_kka', $kategori->kode_kka) }}" 
